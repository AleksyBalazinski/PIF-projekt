...
Wstawiając te wyniki do \autoref{eq:p-exact-formula} dostajemy przybliżenie (dokładne dla dużych $N$)
\begin{equation*}
...
Z \autoref{fig:interaction_retirement_starting}
Poziom 60\%
T z 65 na 67.5 r. 2.5
t0 z 20 na 32 r. 12

\textbf{TODO} opisać \autoref{fig:interaction_lifespan_retirement}.
